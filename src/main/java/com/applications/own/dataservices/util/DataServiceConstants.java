...
//	public static final String GET_ALL_REGISTER_USERS = "SELECT CONCAT(first_name, ' ', last_name) as name,email as email,age as age,deliveryAddress as address FROM TkmyordUser";
	public static final String GET_ALL_REGISTER_USERS = "SELECT tkOrd FROM TkmyordUser tkOrd";
